...
Return the ordered file paths (a maximum of 25 paths) in the following format (and make sure to not include any other text than the list of file paths, no backticks, no "```plaintext", etc., since I will be using the list of filenames in a programmatic context):
...
Now return just the list of file paths ordered by relevancy.